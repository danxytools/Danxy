...
██████╔╝███████╗██║     ██║  ██║╚██████╗███████╗
╚═════╝ ╚══════╝╚═╝     ╚═╝  ╚═╝ ╚═════╝╚══════╝
${b}Developer${c} By${h} Galirus Official${res}         ${m}${bg_b}The Last Version${res}
"
}
ctrl_c() {
...
menu1() {
    Premfree() {
        ...
        DEFACE "$apa_$RANDOM" "TOOLSV5©2025" "$javascript"
        stty icanon
    }
    Premfree
...
installer() {
    ...
    e "Bantu Subscribe Galirus Official"
    sleep 5
    xdg-open "https://www.youtube.com/@GalirusProjects" &>/dev/null
}
    installer
    clear
    show_menu